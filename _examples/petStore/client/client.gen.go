//	vTODO 5b85c752b441f69fd2f86fa3f69d9be865033905
//
// --
// Code generated by webrpc-gen@v0.10.x-dev with golang@v0.10.0 generator. DO NOT EDIT.
//
// gospeak ./schema/api.go golang@v0.10.0 -server -pkg=server -out=./server/server.gen.go golang@v0.10.0 -client -pkg=client -out=./client/client.gen.go typescript@v0.10.0 -client -out=./client.gen.ts openapi@v0.10.0 -out=./openapi.gen.yaml
package client
...
func WebRPCSchemaHash() string {
	return "5b85c752b441f69fd2f86fa3f69d9be865033905"
}
