//	92b42a076a4ca246899b8efe456c5a0ca062c33c
//
// --
// Code generated by webrpc-gen@v0.10.x-dev with golang@v0.10.0 generator. DO NOT EDIT.
//
// gospeak ./schema/api.go golang@v0.10.0 -server -pkg=server -out=./server/server.gen.go golang@v0.10.0 -client -pkg=client -out=./client/petstore.gen.go typescript@v0.10.0 -client -out=./petstore.gen.ts openapi@v0.10.0 -out=./petstore.gen.yaml
package client
...
func WebRPCSchemaHash() string {
	return "92b42a076a4ca246899b8efe456c5a0ca062c33c"
}
