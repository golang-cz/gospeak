// ExampleAPI vTODO 98e66ce20c1c407082853d1ada06d00a6873592d
// --
...
func WebRPCSchemaHash() string {
	return "98e66ce20c1c407082853d1ada06d00a6873592d"
}
...
type ExampleAPI interface {
	...
	GetSession(ctx context.Context) (*User, error)
...
func (s *exampleAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/rpc/ExampleAPI/Get":
		s.serveGet(ctx, w, r)
		return
	case "/rpc/ExampleAPI/GetSession":
		s.serveGetSession(ctx, w, r)
		return
	case "/rpc/ExampleAPI/ListUsers":
...
func (s *exampleAPIServer) serveGet(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *exampleAPIServer) serveGetJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.ExampleAPI.Get(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *User `json:"user"`
	}{ret0}
...
func (s *exampleAPIServer) serveGetSession(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *exampleAPIServer) serveGetSessionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.ExampleAPI.GetSession(ctx)
	}()
	respContent := struct {
		Ret0 *User `json:"user"`
	}{ret0}
...
func (s *exampleAPIServer) serveListUsers(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *exampleAPIServer) serveListUsersJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.ExampleAPI.ListUsers(ctx)
	}()
	respContent := struct {
