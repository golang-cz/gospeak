...
func (c *exampleAPIClient) Get(ctx context.Context, ID int64) (*User, error) {
	in := struct {
		Arg0 int64 `json:"iD"`
	}{ID}
	out := struct {
...
func (c *exampleAPIClient) GetSession(ctx context.Context) (*User, error) {
	out := struct {
		Ret0 *User `json:"user"`
	}{}
...
func (c *exampleAPIClient) ListUsers(ctx context.Context) ([]*User, error) {
	out := struct {
